...
export default function RequestToBook() {
  return (
    <div className="app page-request-to-book">
      ...
      <div className="ctaBar">
        <div className="ctaInner">
          <button className="cta-button" type="button">Check availability with Port Lympne</button>
        </div>
      </div>

      <footer className="site-footer" role="contentinfo" aria-label="Site footer"></footer>
    </div>
  );
}
